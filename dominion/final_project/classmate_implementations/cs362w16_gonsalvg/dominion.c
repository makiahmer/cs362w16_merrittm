/*********************************************************************
** Filename		:	dominion.c
** File Location:	dominion/final_project/classmate_implementations/cs362w16_gonsalvg/
	...
	*state, int handPos, int *bonus)
{
	...
	{
	case adventurer:
		//if this doesn't work call by ref for drawntreasure, cardDrawn, temphand
	...
	case smithy:
		smithy_cardEffect(state, currentPlayer, i, handPos);

	case village:
		village_cardEffect(state, currentPlayer, handPos);
