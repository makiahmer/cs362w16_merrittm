///*********************************************************************
//** Filename		:	dominion.c
//** File Location:	dominion/final_project/classmate_implementations/cs362w16_powersst/
...
//}
//
//int cardAdventurer(struct gameState *state, int drawntreasure, int z, int currentPlayer, int cardDrawn, int *temphand)
//{
...
//}
//
////Does the actions for a gardens card.
//int cardGardens()
//{
//	return -1;
//}
//
////Does the actions for a smithy card.
...
//}
//
////Does the actions for a village card
...
//}
//
////Does the actions for a Great Hall Card
...
//}
//
////Does the actions for a minion card
//int cardMinion(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2)
//{
//	int i;
//	int j;
//
...
//}
//
////Does the actions for a steward card
//int cardSteward(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2, int choice3)
//{
//	if (choice1 == 1)
//	{
//		//+2 cards
